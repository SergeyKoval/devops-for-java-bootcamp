...
## Browser page from instance 1

![](/task1/subtask2/browser_instance1_info-server-page.png)

## AWS peering connection between VPS1 and VPS2 for private IP connectivity

![](/task1/subtask2/aws_peering-connecion-for-private-ip-communication.png)

## Instance 1

### EC2 user data script

[Script](/task1/subtask2/user-data_instance_1.yml).
...
### AWS created instance

![](/task1/subtask2/aws_instance1.png)

### AWS VPC1

![](/task1/subtask2/aws_vpc1.png)

### AWS VPC1 routing table

![](/task1/subtask2/aws_vpc1_route-tables_routes.png)

### AWS VPC1 security group

![](/task1/subtask2/aws_vpc1_security-group_inbound-rules.png)

## Instance 2

### EC2 user data script

[Script](/task1/subtask2/user-data_instance_2.yml).
...
![](/task1/subtask2/aws_instance2.png)

### AWS VPC1

![](/task1/subtask2/aws_vpc2.png)

### AWS VPC1 routing table

![](/task1/subtask2/aws_vpc2_route-tables_routes.png)

### AWS VPC1 security group

![](/task1/subtask2/aws_vpc2_security-group_inbound-rules.png)
